...
/* DEV_UI is configured in TTS console, should also be in little endian format (LSB), see above. (Warning: Should be in UPPERcase letters) */
...
/* This key should be in big endian format (MSB), can be copied as-is.
 Also configured in TTS console  (Warning: Should be in UPPERcase letters) */
...
/* DEV_UI is configured in TTS console, should also be in little endian format (LSB), see above. (Warning: Should be in LOWERcase letters) */
static const u1_t PROGMEM DEVEUI[8] = {0x7b, 0x1b, 0xde, 0x2c, 0x7b, 0x4b, 0x18, 0x5f}; // Original (in MSB) was: 0x5f, 0x18, 0x4b, 0x7b, 0x2c, 0xde, 0x1b, 0x7b

/* This key should be in big endian format (MSB), can be copied as-is.
 Also configured in Chirpstack console (Warning: Should be in LOWERcase letters) */
static const u1_t PROGMEM APPKEY[16] = {0xbc, 0x21, 0x54, 0x80, 0xc2, 0xd7, 0x90, 0xf2, 0xc7, 0xcb, 0xb2, 0x88, 0xc7, 0x55, 0x33, 0xe7};
...
// cycle limitations).
const unsigned TX_INTERVAL = 15; // The time betweend packet deliveries
